...
let task;
let labelStart = "This is the answer to "
let label = labelStart + task + " -----> ";
...
function addFlavor(array,flavor){
    newFlavList = array.unshift(flavor);
    console.log(newFlavList);
}
...
copy("New Array",originalFlavors);
